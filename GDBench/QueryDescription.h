  ...
  void runQuery(Graph & graph, Vertex startVertex, TMSwitch c ) {
    ...
    switch(c) {
      case 1: {
        ...
        v5b.setDepth(2);
        breadthFirstSearch(graph, startVertex, v5b);
  ...
  void runQuery(Graph & graph, Vertex startVertex, TMSwitch c) {
    ...
    switch(c) {
      case 1: {
        ...
        v6b.setDepth(2);
        breadthFirstSearch(graph, startVertex, v6b);
  ...
  void runQuery(Graph & graph, Vertex startVertex, TMSwitch c ) {
    ...
    switch(c) {
      case 1: {
        ...
        v7b.setDepth(2);
        breadthFirstSearch(graph, startVertex, v7b);
  ...
  void runQuery(Graph & graph, Vertex startVertex, Vertex endVertex, TMSwitch c) {
    ...
    switch(c) {
      case 1: {
        ...
        breadthFirstSearch(graph, startVertex, v8b);
  ...
  void runQuery(Graph & graph, Vertex startVertex, Vertex endVertex, TMSwitch c ) {
    ...
    switch(c) {
      case 1: {
        ...
        breadthFirstSearch(graph, startVertex, v9b);
  ...
  void runQuery(Graph & graph, Vertex startVertex, Vertex endVertex, TMSwitch c ) { 
    ...
    switch(c) {
      case 1: {
        ...
        breadthFirstSearch(graph, startVertex, v10d);
  ...
  void runQuery(Graph & graph, Vertex startVertex, Vertex endVertex, TMSwitch c) {
    ...
    switch(c) {
      case 1: {
        ...
        breadthFirstSearch(graph, startVertex, v11b);
...
public:
 void runQuery(Graph & graph, Vertex startVertex, TMSwitch c ) {
    ...
    switch(c) {
      case 1:
        cout << "---------------------BFS---------------------\n";
        breadthFirstSearch(graph, startVertex, v12);
        break;
      case 2:
        cout << "---------------------DFS---------------------\n";
  ...
  void runQuery(Graph & graph, Vertex startVertex, TMSwitch c ) {
    ...
    switch(c) {
      case 1: {
        ...
        v13b.setDepth(3);
        breadthFirstSearch(graph, startVertex, v13b);
