...
//#include "/home/y49cui/research/gem5/m5threads/pthread.c"
...
//         Q1.runQuery(g, 2);
 ...
 //    int traversal = 2;
 //    pthread_t threads[2];
 //    pthread_create(&threads[0], NULL, &Query1::runQuery, &g, (int *)traversal);
 //    pthread_create(&threads[1], NULL, &Query2::runQuery, &g, (int *)traversal);
 //    pthread_exit(NULL);

 /*------------ std::thread ----------*/
     std::vector<std::thread> threads;
 
     threads.push_back(thread([&]{Q3.runQuery(g, 2);}));
     threads.push_back(thread([&]{Q2.runQuery(g, 2);}));
